...
import { enquiriesCountGraphViewGroupWiseFormFields } from "./enquiries-count-graph-view-group-wise-form-fields";
...
export const EnquiriesCountGraphViewGroupWise: React.FC = () => {
          ...
          <BorderLayout heading={cardConfig.formLayoutConfig.heading}>
            <div className="row">
              <div className="col-md-3 col-xs-12">
                <Select
                  config={
                    enquiriesCountGraphViewGroupWiseFormFields.group.config
                  }
              ...
              <div className="col-md-3 col-xs-12">
                <Select
                  config={
                    enquiriesCountGraphViewGroupWiseFormFields.city.config
                  }
                  // onChangeHandler={companyOnChangeHandler}
                />
              </div>
              <div className="col-md-2 col-xs-12">
                <SingleCheckbox
                  config={
                    enquiriesCountGraphViewGroupWiseFormFields
                      .clientwiseSeperate.config
                  }
                  // onChangeHandler={companyOnChangeHandler}
                />
              </div>
              <div className="col-md-4 col-xs-12">
                <div className="row">
                  <div className="col">
                    <Select
                      config={
                        enquiriesCountGraphViewGroupWiseFormFields.client.config
                      }
                      // onChangeHandler={companyOnChangeHandler}
                    />
                  </div>
          ...
          <BorderLayout heading={cardConfig.formListConfig.heading}>
            <div className="row">
              <div className="col-2 ex1">
                ...
                <SingleCheckbox
                  config={
                    enquiriesCountGraphViewGroupWiseFormFields.selectAll.config
                  }
                />
            ...
            <div className="row">
              <div className="col-2 ex1">
                ...
                <Checkbox
                  config={
                    enquiriesCountGraphViewGroupWiseFormFields.month.config
                  }
                />
              </div>
              <div className="col-4 ex1"></div>
              <div className="col-6 ex1">
