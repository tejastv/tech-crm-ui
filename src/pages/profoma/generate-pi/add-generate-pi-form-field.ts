...
const currencyinwordValidation = {
    ...
    pattern: {
        ...
        message: "Invalid Currency in Word format. Please enter a valid currency name (e.g., USD).",
      },
  } as ValidationType;
const invoicenoValidation = {
    ...
    pattern: {
      ...
      message: "Invalid Invoice Number format. Please enter a valid invoice number (e.g., ABC123).",
    },
  } as ValidationType;
const amountValidation = {
    ...
    pattern: {
      ...
      message: "Invalid amount format. Please enter a valid amount (e.g., 123.45).",
    },
  } as ValidationType;
